...
public class Storage {
	...
	/***
	 * |вычисление рассто¤ни¤ между адресами
	...
	public SetFragment calc_way(Pair p1, Pair p2) {
		//тут по данным в mass строитс¤ объект пути
		...
		//перед этим проверим, можно ли старт и конец напр¤мую соединить
		//если по всем позици¤ми по этому пути будет пусто - значит, можем
		//критерий - одинаковые y-позиции у начальной и конечной точки, когда смещение только по x
		
			//найти ближайшие сечени¤ к y-координатам обоих точет
			...
			//координата x беретс¤ у точки старта, а y - это ближайщий тех проход
			//путь идет пр¤мо по технологическому проходу, покуда координата x не достигнет
